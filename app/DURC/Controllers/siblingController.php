...
class siblingController extends DURCController
{
    ...
    */ 
	...
	$tmp_sibling = $myNewsibling;
		...
		$tmp_sibling->created_at = DURC::formatForStorage( 'created_at', 'datetime', $request->created_at ); 
		$tmp_sibling->updated_at = DURC::formatForStorage( 'updated_at', 'datetime', $request->updated_at ); 
		$tmp_sibling->save();
