...
class foreignkeytestgizmoController extends DURCController
{
    ...
    */ 
	...
	$tmp_foreignkeytestgizmo = $myNewforeignkeytestgizmo;
		...
		$tmp_foreignkeytestgizmo->created_at = DURC::formatForStorage( 'created_at', 'datetime', $request->created_at ); 
		$tmp_foreignkeytestgizmo->updated_at = DURC::formatForStorage( 'updated_at', 'datetime', $request->updated_at ); 
