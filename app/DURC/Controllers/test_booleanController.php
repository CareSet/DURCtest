...
class test_booleanController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$img_field = test_boolean::getImgField();
    ...
    */ 
    ...
    public function jsonone(Request $request, $test_boolean_id){
		...
		$img_uri_field = \App\test_boolean::getImgField();
		if(!is_null($img_uri_field)){ //then this object has an image link..
			if(!isset($return_me_array['card_img_top'])){ //allow the user to use this as a field without pestering..
				$return_me_array['card_img_top'] = $test_boolean->$img_uri_field;
			}
		}
		...
		if(!isset($return_me_array['card_body'])){ //allow the user to use this as a field without pestering..
			...
			$return_me_array['card_body'] = $test_boolean->getCardBody();
		}
    ...
    public function destroy(test_boolean $test_boolean){
	    return test_boolean::destroy( $test_boolean->id );  
    }
    ...
    {
        $test_boolean = test_boolean::withTrashed()->find($id)->restore();
