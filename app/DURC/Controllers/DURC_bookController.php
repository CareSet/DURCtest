...
class DURC_bookController extends DURCController
{
    ...
    */ 
	...
	$tmp_book = $myNewbook;
			$tmp_book->id = $request->id; 
		$tmp_book->title = $request->title; 
		$tmp_book->release_date = $request->release_date; 
		$tmp_book->created_at = $request->created_at; 
		$tmp_book->updated_at = $request->updated_at; 
		$tmp_book->save();
