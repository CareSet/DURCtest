...
class funnythingController extends DURCController
{
    ...
    */ 
	...
	$tmp_funnything = $myNewfunnything;
		...
		$tmp_funnything->thistext = DURC::formatForStorage( 'thistext', 'text', $request->thistext ); 
		...
		$tmp_funnything->thistinytext = DURC::formatForStorage( 'thistinytext', 'tinytext', $request->thistinytext ); 
		$tmp_funnything->save();
