...
class orderdetailController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$img_field = orderdetail::getImgField();
    ...
    */ 
    ...
    public function jsonone(Request $request, $orderdetail_id){
		...
		if(!is_null($img_uri_field)){ //then this object has an image link..
			if(!isset($return_me_array['card_img_top'])){ //allow the user to use this as a field without pestering..
				$return_me_array['card_img_top'] = $orderdetail->$img_uri_field;
			}
		}
		...
		if(!isset($return_me_array['card_body'])){ //allow the user to use this as a field without pestering..
			...
			$return_me_array['card_body'] = $orderdetail->getCardBody();
		}
    ...
    {
        $orderdetail = orderdetail::withTrashed()->find($id)->restore();
