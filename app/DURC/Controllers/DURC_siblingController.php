...
class DURC_siblingController extends DURCController
{
    ...
    */ 
	...
	$tmp_sibling = $myNewsibling;
			$tmp_sibling->id = $request->id; 
		$tmp_sibling->siblingname = $request->siblingname; 
		$tmp_sibling->step_sibling_id = $request->step_sibling_id; 
		$tmp_sibling->sibling_id = $request->sibling_id; 
		$tmp_sibling->created_at = $request->created_at; 
		$tmp_sibling->updated_at = $request->updated_at; 
		$tmp_sibling->save();
