...
class DURC_authortypeController extends DURCController
{
    ...
    */ 
	...
	$tmp_authortype = $myNewauthortype;
			$tmp_authortype->id = $request->id; 
		$tmp_authortype->authortypedesc = $request->authortypedesc; 
		$tmp_authortype->created_at = $request->created_at; 
		$tmp_authortype->updated_at = $request->updated_at; 
		$tmp_authortype->save();
