...
class DURC_foreignkeytestthingyController extends DURCController
{
    ...
    */ 
	...
	$tmp_foreignkeytestthingy = $myNewforeignkeytestthingy;
			$tmp_foreignkeytestthingy->id = $request->id; 
		$tmp_foreignkeytestthingy->thingyname = $request->thingyname; 
		$tmp_foreignkeytestthingy->gizmopickupaskey = $request->gizmopickupaskey; 
		$tmp_foreignkeytestthingy->created_at = $request->created_at; 
		$tmp_foreignkeytestthingy->updated_at = $request->updated_at; 
		$tmp_foreignkeytestthingy->deleted_at = $request->deleted_at; 
