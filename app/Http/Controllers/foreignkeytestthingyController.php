...
class foreignkeytestthingyController extends DURCParentController
{
    ...
    public function show(foreignkeytestthingy $foreignkeytestthingy){
        // enter your stuff here if you want...
	return(parent::show($foreignkeytestthingy));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(foreignkeytestthingy $foreignkeytestthingy, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($foreignkeytestthingy));
    }
    ...
    public function update(Request $request, foreignkeytestthingy $foreignkeytestthingy){
        // enter your stuff here if you want...
	return(parent::update($request,$foreignkeytestthingy));
    }
    ...
    public function destroy(foreignkeytestthingy $foreignkeytestthingy){
        // enter your stuff here if you want...
	return(parent::destroy($foreignkeytestthingy));
    }
