...
class authortypeController extends DURCParentController
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(authortype $authortype, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($authortype));
    }
    ...
    public function update(Request $request, authortype $authortype){
        // enter your stuff here if you want...
	return(parent::update($request,$authortype));
    }
    ...
    public function destroy(authortype $authortype){
        // enter your stuff here if you want...
	return(parent::destroy($authortype));
    }
