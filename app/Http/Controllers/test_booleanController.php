...
FILE_SIG=a353251a5e91a496486b859527b33470
*/
...
class test_booleanController extends DURCParentController
{
    ...
    public function show(test_boolean $test_boolean){
        // enter your stuff here if you want...
	return(parent::show($test_boolean));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(test_boolean $test_boolean, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($test_boolean));
    }
