...
FILE_SIG=8f1d1c64dacf79bf0fcbeb6bcf24c897
*/
...
class test_created_onlyController extends DURCParentController
{
    ...
    public function show(test_created_only $test_created_only){
        // enter your stuff here if you want...
	return(parent::show($test_created_only));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(test_created_only $test_created_only, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($test_created_only));
    }
