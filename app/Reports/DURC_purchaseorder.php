...
FILE_SIG=1203da57fad234164bc97f00551335ea
*/
...
FROM northwind_data.purchaseOrder

LEFT JOIN northwind_model.supplier AS A_supplier ON 
	A_supplier.id =
	purchaseOrder.supplier_id

LEFT JOIN northwind_model.employee AS B_employee ON 
	B_employee.id =
	purchaseOrder.createdBy_employee_id

LEFT JOIN northwind_model.employee AS C_employee ON 
	C_employee.id =
	purchaseOrder.approvedBy_employee_id

LEFT JOIN northwind_model.employee AS D_employee ON 
	D_employee.id =
